...
set NODE_PACKAGE_ZIP=%APP_RUN_RESOURCES_DIR%\binaries\node.zip
rem set NODE_PACKAGE_ZIP=%NODE_DIR%\%NODE_PACKAGE_FOLDER%.zip
...
rem set PHP_PACKAGE_URL=https://windows.php.net/downloads/releases/php-8.2.3-nts-Win32-vs16-x64.zip
rem set PHP_PACKAGE_ZIP=%PHP_DIR%\php.zip
set PHP_PACKAGE_ZIP=%APP_RUN_RESOURCES_DIR%\binaries\php.zip
